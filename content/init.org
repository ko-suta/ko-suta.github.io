...
#+begin_src emacs-lisp
  ...
  (progn
    (set-face-attribute 'ivy-current-match nil :foreground "black"  :background "orange")
...
#+begin_src emacs-lisp
  ...
  ;; added the following code after =auctex= update (to enable auctex-latexmk)
  ;; source: https://www.reddit.com/r/emacs/comments/vl38v0/setting_auxtex_to_run_latexmk/
  ;; (eval-after-load "tex"
...
(defvar my-mu4e-account-alist
  '(("Gmail"
     (user-mail-address "k.ovsiannikov@gmail.com")
     (smtpmail-smtp-user "k.ovsiannikov")
